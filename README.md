...
### 点击播放视频 ▼
[![Watch the video](https://i.sstatic.net/Vp2cE.png)](https://www.bilibili.com/video/BV1gn8XeNE2J?p=84)
...
|id (主键)|bigint(20)|否||主键|
|addtime|timestamp|否|CURRENT\_TIMESTAMP|创建时间|
|tablename|varchar(200)|是|qichexinxi|商品表名|
|userid|bigint(20)|否||用户id|
...
|id (主键)|bigint(20)|否||主键|
|addtime|timestamp|否|CURRENT\_TIMESTAMP|创建时间|
|qichepinpai|varchar(200)|是|NULL|汽车品牌|
表4.8 汽车信息表
...
|id (主键)|bigint(20)|否||主键|
|addtime|timestamp|否|CURRENT\_TIMESTAMP|创建时间|
|qichepinpai|varchar(200)|否||汽车品牌|
|chexi|varchar(200)|否||车系|
|tupian|varchar(200)|是|NULL|图片|
|shangpaishijian|varchar(200)|否||上牌时间|
|biaoxianlicheng|varchar(200)|否||表显里程|
|paifangbiaozhun|varchar(200)|是|NULL|排放标准|
|biansuxiang|varchar(200)|是|NULL|变速箱|
|pailiang|varchar(200)|是|NULL|排量|
|guohu|varchar(200)|是|NULL|过户|
